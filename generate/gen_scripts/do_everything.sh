...
python3 utils/memmaker.py $DESIGNDIR/mem/init.txt $WIDTH $DEPTH $DATA $PERLINE
python3 utils/make_top.py $DESIGNDIR/top.sv $WIDTH $DEPTH $DESIGNDIR/mem/init.txt #$INIT_FRMT
